...
import { getAtendente, updateAtendente, deleteAtendente } from '@/features/atendentes/server'
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <FormSection title="Acesso ao Sistema">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="sm:col-span-2">
              <Field label="Nova Senha (opcional)" error={errors.password?.message}>
                <input {...register('password')} type="password" placeholder="Deixe em branco para manter" className={inputCls} />
              </Field>
            </div>
          </div>
        </FormSection>
