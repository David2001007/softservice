        ...
        <div className="flex items-center gap-3">
          ...
          {user && (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <div className="flex items-center gap-2.5 cursor-pointer group hover:bg-surface-hover p-1.5 rounded-xl transition-colors">
                  ...
                  <div className="hidden sm:block">
                    <p className="text-xs font-semibold text-text leading-tight capitalize">
                      {user.nome}
                    </p>
                    <p className="text-[10px] text-text-muted leading-tight capitalize">
                      {user.role}
                    </p>
                  </div>
              ...
              <DropdownMenuContent
                align="end"
                className="w-56 mt-2 rounded-xl bg-surface/95 backdrop-blur-sm border-white/10"
              >
                <DropdownMenuLabel className="font-normal">
                  <div className="flex flex-col space-y-1">
                    <p className="text-sm font-bold leading-none text-text">
                      {user.nome}
                    </p>
